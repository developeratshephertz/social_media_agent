...
async def serve_frontend(path: str):
    ...
    if os.path.exists("static/index.html"):
        ...
        return FileResponse("static/index.html") if os.path.exists("static/index.html") else {"message": "Instagram Post Generator API v3.0", "status": "running", "endpoints": ["/", "/health", "/generate-post", "/generate-caption", "/generate-batch"]}
