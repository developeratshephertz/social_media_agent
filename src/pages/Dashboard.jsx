  ...
  return (
    <div className="space-y-8">
        ...
        <div className="lg:col-span-3 h-[500px] flex flex-col gap-6">
          ...
          <div className="flex-1 min-h-0">
            <Card title="Recent Activity" className="h-full flex flex-col">
              <div className="flex-1 min-h-0 overflow-y-auto max-h-[180px]">
          ...
          {/* Upcoming Posts */}
          <div className="flex-1 min-h-0">
            <Card title="Upcoming Posts" className="h-full flex flex-col">
              <div className="flex-1 min-h-0 overflow-y-auto max-h-[180px]">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <div 
            className="cursor-pointer hover:bg-[var(--bg-muted)] p-2 rounded-lg transition-all duration-200 hover:scale-[1.02]"
            onClick={() => navigate('/idea-generator')}
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold">Idea Generator</h3>
