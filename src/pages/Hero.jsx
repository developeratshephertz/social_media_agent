    ...
    <section className="glass p-8 rounded-3xl flex items-center justify-between">
      <div className="max-w-xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="ghost" size="sm" onClick={generateHelpDoc}>Learn more</Button>
        </div>
      </div>
      <div className="w-1/4 flex justify-end">
        <div className="rounded-2xl shadow-xl p-4" style={{ background: '#dff6e9', minWidth: 180, minHeight: 110 }}>
