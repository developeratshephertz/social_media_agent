...
export default function Modal({ open, onOpenChange, title, children, ariaLabel }) {
  ...
  const modal = (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div role="dialog" aria-modal="true" aria-label={ariaLabel || title} tabIndex={-1} ref={ref} className="bg-[var(--surface)] border border-[var(--border)] rounded-xl shadow-lg p-6 z-10 max-w-6xl w-full mx-4 focus:outline-none max-h-[90vh] overflow-y-auto modal-content">
